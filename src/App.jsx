...
export default function App() {
  ...
  const renderLegal = (title, content) => (
    <section className="pt-40 pb-40 px-6 max-w-4xl mx-auto min-h-screen animate-in fade-in duration-500">
      ...
      <div className="prose prose-zinc max-w-none space-y-8 text-zinc-500 leading-loose">
        {content}
      </div>
    </section>
  );
